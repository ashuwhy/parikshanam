  ...
  return (
    <aside className="w-52 min-h-screen bg-brand-navy flex flex-col flex-shrink-0">
      <div className="px-4 py-5">
        <span className="inline-block bg-brand-teal text-white text-xs font-bold px-2 py-1 rounded-md">
          📖 TEACHER
        </span>
      ...
      <nav className="flex-1 py-2">
        <p className="px-4 text-white/50 text-[10px] uppercase tracking-widest mb-2">Teaching</p>
        {NAV.map(({ href, label }) => {
          ...
          return (
            <Link
              ...
              className={`block px-4 py-2 text-sm ${
                active
                  ? 'bg-white/10 border-l-4 border-brand-teal text-white font-medium'
